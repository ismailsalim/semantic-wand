...
class CoarseStage:
    def __init__(self, cfg, thresh):
        ...
        # self.cfg.MODEL.ROI_MASK_HEAD.CLS_AGNOSTIC_MASK = False
        # self.cfg.MODEL.ROI_HEADS.IOU_THRESHOLDS = [0.001]
        # self.cfg.MODEL.ROI_BOX_CASCADE_HEAD.IOUS = [0.001, 0.002, 0.003]
